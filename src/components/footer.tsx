            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm text-neutral-500 dark:text-neutral-400">
                        ...
                        <li><a href="/resume.pdf" download="Sabiq-Sabry-CV.pdf" className="hover:text-neutral-900 dark:hover:text-neutral-50">Resume</a></li>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm text-neutral-500 dark:text-neutral-400">
                        ...
                        <li><Link href="/products" className="hover:text-neutral-900 dark:hover:text-neutral-50">Projects</Link></li>
